...
dt = DecisionTreeClassifier(criterion='entropy', random_state=0, max_depth=5, min_samples_leaf=2)

scores = cross_val_score(dt, X, np.ravel(y, order='C'), cv=cv, scoring='accuracy')

# saving results to files
np.savetxt('../results/CART_CV30_normal.txt', scores)
scores.tofile('../results/CART_CV30_normal.dat')
