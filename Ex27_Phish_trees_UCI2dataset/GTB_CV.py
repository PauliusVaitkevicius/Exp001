...
cls = GradientBoostingClassifier(n_estimators=50, learning_rate=1.0, max_depth=3, random_state=0, min_samples_leaf=2)
# ------------------------------------------
...
np.savetxt('../results/GTB_CV30_normal_UCI2dataset.txt', scores)
