...
scores = cross_val_score(knn, X, np.ravel(y, order='C'), cv=cv, scoring='accuracy')
print(scores)

# saving results to files
np.savetxt('../results/kNN_N5_normal.txt', scores)
scores.tofile('../results/kNN_N5_normal.dat')
