...
cls = MLPClassifier(solver='adam', alpha=1e-4, hidden_layer_sizes=(150, ), learning_rate='adaptive', max_iter=1000)
# ------------------------------------------
...
np.savetxt('../results/NN_MLP_CV30_normal_UCIdataset.txt', scores)
# ------------------------------------------
