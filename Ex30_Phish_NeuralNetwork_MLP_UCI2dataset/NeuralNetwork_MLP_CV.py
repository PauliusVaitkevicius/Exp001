...
cls = MLPClassifier(solver='adam', alpha=1e-4, hidden_layer_sizes=(30, ), learning_rate='adaptive', max_iter=3000)
# ------------------------------------------
...
np.savetxt('../results/NN_MLP_CV30_normal_UCI2dataset.txt', scores)
# ------------------------------------------
